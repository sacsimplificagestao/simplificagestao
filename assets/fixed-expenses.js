...
createForm.addEventListener('submit', async (e) => {
  ...
  const categoria = document.getElementById('create-category').value.trim()
  ...
  if (!descricao || !valor || !dia_vencimento) {
    showTopMessage('Preencha descrição, valor e dia do vencimento.', 'error')
    return
  }
...
editForm.addEventListener('submit', async (e) => {
  ...
  const categoria = document.getElementById('edit-category').value.trim()
